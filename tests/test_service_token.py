...
class TestTokenService:
    ...
    async def test_create_2(self, db_session):
        ...
        user_id_b = await service.decode_and_verify_refresh_token(tokens.refresh_token)
